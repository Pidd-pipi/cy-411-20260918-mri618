...
export const LogTemplates = {
  ...
  GOAL_ADJUST_START: 'Goal[id={id}] adjustment start effective_date={effectiveDate} new_target={newTargetValue}',
  GOAL_ADJUST_SUCCESS: 'Goal[id={id}] adjustment success adjustment_id={adjustmentId} original={originalTargetValue} new={newTargetValue} effective_date={effectiveDate}',
  GOAL_ADJUST_FAILED: 'Goal[id={id}] adjustment failed: {field} {reason}',
  GOAL_ADJUST_SEGMENTS_CALCULATED: 'Goal[id={id}] segments recalculated originalRemaining={originalRemaining} newRemaining={newRemaining}',
